...
namespace TerrainGenerator
{
    public class TerrainData
    {
        ...
        public void SaveToOBJ(string filePath)
        {
            ...
            {
                file.WriteLine("# Terrain OBJ File Generated by TerrainGenerator");
        ...
        public void SaveToFBX(string filePath)
        {
            ...
            System.IO.File.WriteAllText(filePath, fbxContent);
        }
        ...
        private string GenerateFBXContent()
        {
            ...
            sb.AppendLine("; Generated by TerrainGenerator");
            sb.AppendLine();
        ...
        public System.Drawing.Bitmap GenerateHeightmapImage()
        {
            ...
            for (int x = 0; x < Width; x++)
            {
                for (int z = 0; z < Height; z++)
                {
                    float normalizedHeight = (HeightMap[x, z] - minHeight) / range;
                    int grayValue = (int)(normalizedHeight * 255);
                    bitmap.SetPixel(x, z, System.Drawing.Color.FromArgb(grayValue, grayValue, grayValue));
                }
            }
        ...
        public void SaveHeightmapTexture(string filePath)
        {
            using (var bitmap = GenerateHeightmapImage())
            {
