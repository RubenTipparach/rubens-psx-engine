...
namespace rubens_psx_engine
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            //byte[] bytecode = File.ReadAllBytes("base\\bloom\\Dither.xnb");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            SetBlurEffectParameters(0.0f / (float)renderTarget1.Width, 0);
            ...
            SetBlurEffectParameters(0, 0.0f / (float)renderTarget1.Height);
                                ...
                                Effect effect, IntermediateBuffer currentBuffer)
        {
            ...
            {
                effect = null;
                Console.WriteLine("buffer ouyt of order.");
            }
