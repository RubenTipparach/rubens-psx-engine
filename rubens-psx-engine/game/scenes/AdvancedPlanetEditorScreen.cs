...
{
    public class AdvancedPlanetEditorScreen : PhysicsScreen
    {
        ...
        public AdvancedPlanetEditorScreen()
        {
            ...
            // Create planet
            planet = new AdvancedPlanetRenderer(gd, radius: 20f, subdivisionLevel: 128);
        ...
        public override void Draw2D(GameTime gameTime)
        {
            ...
            // Draw instructions
            string instructions = "Advanced Planet Editor\n\n" +
