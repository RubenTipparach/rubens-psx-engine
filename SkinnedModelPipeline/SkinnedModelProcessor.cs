// Based on Microsoft XNA Community Game Platform SkinnedModel Sample
// Adapted for MonoGame
...
{
    [ContentProcessor(DisplayName = "Skinned Model - Custom")]
    public class SkinnedModelProcessor : ModelProcessor
    {
        public override ModelContent Process(NodeContent input, ContentProcessorContext context)
        {
            ...
            if (bones.Count > 72) // SkinnedEffect.MaxBones
            {
